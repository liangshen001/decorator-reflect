...
type PropertyMethodClassAnnotation<O> = (option: O) => (MethodDecorator & ClassDecorator & PropertyDecorator);
...
export {PropertyMethodClassAnnotation, PropertyMethodClassAnnotationBuilder};
