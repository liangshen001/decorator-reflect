...
type ParameterPropertyClassAnnotation<O> = (option: O) => (ParameterDecorator & PropertyDecorator & ClassDecorator);
...
export {ParameterPropertyClassAnnotation, ParameterPropertyClassAnnotationBuilder};
