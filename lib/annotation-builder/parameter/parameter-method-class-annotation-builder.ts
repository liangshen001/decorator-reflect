...
type ParameterMethodClassAnnotation<O> = (option: O) => (ParameterDecorator & MethodDecorator & ClassDecorator);
...
export {ParameterMethodClassAnnotation, ParameterMethodClassAnnotationBuilder};
