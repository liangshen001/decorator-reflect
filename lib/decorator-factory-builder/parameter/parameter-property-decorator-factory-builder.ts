...
type ParameterPropertyDecoratorFactory<O> = ParameterDecoratorFactory<O> & PropertyDecoratorFactory<O>
...
class ParameterPropertyDecoratorFactoryBuilder<O>
    ...
    public build(): ParameterPropertyDecoratorFactory<O> {
        return <any> MakeDecoratorUtil.makeParameterAndPropertyAndMethodAndClassDecorator<O>(
            this.parameterHandler, this.propertyHandler, undefined, undefined, this.defaultOption, this.metadataKey);
    }
