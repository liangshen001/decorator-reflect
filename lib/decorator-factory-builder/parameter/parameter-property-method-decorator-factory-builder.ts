...
type ParameterPropertyMethodDecoratorFactory<O> = ParameterDecoratorFactory<O> & PropertyDecoratorFactory<O> & MethodDecoratorFactory<O>;
...
class ParameterPropertyMethodDecoratorFactoryBuilder<O>
    ...
    public build(): ParameterPropertyMethodDecoratorFactory<O> {
        return <any> MakeDecoratorUtil.makeParameterAndPropertyAndMethodAndClassDecorator<O>(
            this.parameterHandler, this.propertyHandler, this.methodHandler, undefined, this.defaultOption, this.metadataKey);
    }
